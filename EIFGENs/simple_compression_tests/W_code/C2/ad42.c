...
extern EIF_TYPED_VALUE F42_848(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F42_849(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
EIF_TYPED_VALUE F42_849 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 41, Current, 0, 0, 893);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
