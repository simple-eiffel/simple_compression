...
extern void F150_1981(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F150_1981 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 149, Current, 0, 1, 1989);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1788, 0x10000000, 1); /* position */
	*(EIF_INTEGER_32 *)(Current + RTWA(1788, dtype)) = (EIF_INTEGER_32) arg1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
