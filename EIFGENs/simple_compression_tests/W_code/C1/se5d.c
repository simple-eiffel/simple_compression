...
static const EIF_TYPE_INDEX egt_11_5 [] = {0xFF01,19,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_NON_GENERIC(0x01F5 /*250*/), 63, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01F5 /*250*/), 64, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01F5 /*250*/), 65, 0xFFFFFFFF},
};
void Init5(void)
{
	IDSC(desc_5, 0, 4);
	IDSC(desc_5 + 1, 4, 4);
	IDSC(desc_5 + 32, 272, 4);
}
