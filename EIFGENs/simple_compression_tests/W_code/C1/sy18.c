...
extern void F18_6990(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F18_350 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 17, Current, 0, 0, 349);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F18_6990 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 17, Current, 0, 6989);
	RTSA(Dtype(Current));
