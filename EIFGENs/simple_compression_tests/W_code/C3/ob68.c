...
extern EIF_TYPED_VALUE F68_1252(EIF_REFERENCE);
...
EIF_TYPED_VALUE F68_1252 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 67, Current, 0, 0, 1276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(67, Current, 1276);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80002C2, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,706,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;
