...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F20_360);
	dtype = Dtype(Current);
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(365, dtype))(Current)).it_c1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 376);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F20_362 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 377);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F20_363 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 378);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F20_364 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 379);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F20_365 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 380);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F20_366 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 19, Current, 0, 0, 381);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
