...
EIF_TYPED_VALUE F128_1673 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 127, Current, 0, 0, 1687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(127, Current, 1687);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1617, 136))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 127, Current, 0, 0, 1686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(127, Current, 1686);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
